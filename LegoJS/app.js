...
app.post('/create-set', (req, res) => {
  const { set_name } = req.body; // Get the custom set name from the form
...
app.post('/add-part', (req, res) => {
  const { set_id, part_num, quantity } = req.body; // Extract data from the form
...
app.post('/delete-part', (req, res) => {
  const { set_id, part_num } = req.body; // Extract data from the form
...
app.post('/search-set', (req, res) => {
  const { search } = req.body; // Get search term
